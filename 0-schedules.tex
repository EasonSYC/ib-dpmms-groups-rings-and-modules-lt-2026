...
\noindent Rings \(\ZZ\bqty{\alpha}\) of algebraic integers as subsets of \(\CC\) and quotients of \(\ZZ\bqty{x}\). Examples of Euclidean domains and uniqueness and non-uniqueness of factorization. Factorization in the ring of Gaussian integers; representation of integers as sums of two squares.
