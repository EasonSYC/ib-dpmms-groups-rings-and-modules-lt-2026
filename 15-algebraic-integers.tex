...
\begin{proof}
    ...
    \[
        \ZZ\bqty{x} / \ker\pqty{e_\alpha} \isomorphic \ZZ\bqty{x} / \pqty{f_{\alpha}} \subring \CC
    \]
    so \(\ZZ\bqty{x} / \pqty{f_{\alpha}}\) is an integral domain. It follows that \(f_\alpha\) is prime, hence irreducible.
\end{proof}
