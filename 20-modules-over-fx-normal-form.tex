...
\begin{example}
    ...
    \[
        V_{\alpha} \isomorphic \FF\bqty{x} / \pqty{x^r}.
    \]
    ...
    \[
        \function{\alpha}{\FF\bqty{x} / \pqty{x^r}}{\FF\bqty{x} / \pqty{x^r}}{f}{xf.}
    \]
...
\begin{example}[Jordan Block]
    ...
    Suppose now instead
    \[
        V_{\alpha} \isomorphic \FF\bqty{x} / \pqty{x - \lambda}^r.
    \]
...
\begin{example}[Companion Matrix]
    ...
    Suppose now
    \[
        V_{\alpha} \isomorphic \FF\bqty{x} / p\pqty{x}
    \]
    ...
    \[
        \function{\alpha}{\FF\bqty{x} / p\pqty{x}}{\FF\bqty{x} / p\pqty{x}}{f}{xf}
    \]
...
\begin{theorem}[Rational Canonical Form]
    ...
    \[
        V_{\alpha} \isomorphic \FF\bqty{x} / \pqty{f_1} \oplus \cdots \oplus \FF\bqty{x} / \pqty{f_s}
    \]
    ...
    \[
        \alpha = \begin{pmatrix}
            ...
            & & \ddots \\
            & & & \vb{C} \pqty{f_s}
        \end{pmatrix} = \diag\pqty{\vb{C} \pqty{f_1}, \ldots, \vb{C} \pqty{f_s}}.
    \]
\end{theorem}
...
\begin{theorem}[Jordan Canonical Form]
    ...
    \[
        V_{\alpha} \isomorphic \CC\bqty{x} / \pqty{x - \lambda_1}^{\alpha_1} \oplus \cdots \oplus \CC\bqty{x} / \pqty{x - \lambda_t}^{a_t}.
    \]

    There exists a basis of \(V\), such that
    \[
        \alpha = \begin{pmatrix}
            \vb{J}_{a_1} \pqty{\lambda_1} \\
            & \vb{J}_{a_2} \pqty{\lambda_2} \\
            & & \ddots \\
            & & & \vb{J}_{a_t} \pqty{\lambda_t}
        \end{pmatrix}
